 ...
 * course is only a rough global observed behavior, it is not a guarantee for
 * every double numbers input (see William Kahan's Table Maker's Dilemma).
 * 
 * 
 * 
 * 
...
public class FastMath {
	 ...
	 * 
	 * 
	 * This compile-time constant should be set to true only if one explicitly wants
	 * to compute the tables at class loading time instead of using the already
	 * computed ones provided as literal arrays below.
	 * 
	 * 
	 */
	...
	private static double exp(double x, double extra, double[] hiPrec) {
		 ...
		 * last step to avoid possible loss of percison.
		 */
		 ...
		 * combined with the contant 1. This will be used in the last addition below to
		 * get proper rounding.
		 */
	 ...
	 * @return the value of the logarithm, i.e. the number {@code y} such that basey
	 *         = x.
	 ...
	 * 
	 * 
	 * If the dividend is an infinity, or the divisor is a zero, or both, the result
	 * is NaN.
	 * 
	 * 
